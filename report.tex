...
Finally, we consider the phrases with the highest tf-idf values to be the "top" phrases for the corresponding time period.
\subsection{Classification}
\subsection{Clustering}

\section{Results} % What did I find out?
\subsection{EDA}
Figure \ref{figure:top_phrases_by_decade} displays the top phrases by decade.
\begin{itemize}
    \item 1900s:
    \item 1910s:
    \item 1920s:
...
Figure \ref{figure:top_phrases_by_decade} in \nameref{appendix} goes into finer detail by displaying top phrases by year, rather than decade and is also available as an \href{https://www.youtube.com/watch?v=8aOob6iJO5Y}{animation}.
