...
Movies often capture human culture and major events over time. We can learn from this rich source of human history through a comprehensive textual analysis of movies, i.e., movie plot summaries.
...
The variable of focus here is \texttt{summary}, from which we extract phrases to drive our analysis.
