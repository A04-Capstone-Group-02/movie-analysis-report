...
\begin{itemize}
    ...
    \item \textit{1930s}: Stan and Ollie continue to be salient in this decade. We see the appearance of movie characters Alfafa, Buckwheat, Spanky, and Stymie from the \textit{Our Gang} comedy series, Betty Boop and Bimbo from the \textit{Talkartoon} and \textit{Betty Boop} cartoon series, and actors Robert Armstrong from \textit{King Kong} and Edward Arnold from \textit{Mr. Smith Goes to Washington}.
    \item \textit{1940s}: Many of the top phrases and their corresponding top movies in this decade relate to World War II, fought from 1939 to 1945. This includes the phrases ``World War II'' and ``Nazi'' and the movies \textit{Foreign Correspondent}, \textit{The Best Years of Our Lives}, \textit{The White Cliffs of Dover}, and \textit{Hitler's Children}. We see the appearance of Moe and Larry, the two mainstay members of The Three Stooges, a famous comedy team active from the 1920s to 1970s (the third stooge changed multiple times throughout the team's history), Mammy Two Shoes from the the \textit{Tom and Jerry} cartoon series, Daffy Duck from the \textit{Looney Tunes} and \textit{Merrie Melodies} cartoon series, actor Harry Davenport from \textit{Foreign Correspondent}, and the reappearance of Buckwheat.
    \item \textit{1950s}:
    \item \textit{1960s}:
    \item \textit{1970s}:
    \item \textit{1980s}:
...
Figure \ref{figure:top_phrases_by_year} in \nameref{appendix} goes into finer detail by showing top phrases by year instead of decade and is also available as an \href{https://www.youtube.com/watch?v=8aOob6iJO5Y}{animation}. Here, we observe a similar trend of top phrases across time but also observe phrases that are peculiar to each year.
