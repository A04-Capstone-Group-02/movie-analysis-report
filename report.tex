...
\begin{itemize}
    ...
    \item \textit{1950s}: We continue to see phrases and movies relating to World War II, including the movie \textit{Giant}. We see the appearance of movie characters \ldots, actors \ldots, and the reappearance of \ldots.
    \item \textit{1960s}:
    \item \textit{1970s}:
    \item \textit{1980s}:
    \item \textit{1990s}:
