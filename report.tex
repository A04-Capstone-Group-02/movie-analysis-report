...
\centering
\adjincludegraphics[trim=0 {.53\height} 0 0,clip,width=\textwidth]{figures/top_phrases_by_year_bar_chart.png}
...
\ContinuedFloat
\centering
\adjincludegraphics[trim=0 0 0 {.47\height},clip,width=\textwidth]{figures/top_phrases_by_year_bar_chart.png}
\end{figure*}
\end{multicols}
